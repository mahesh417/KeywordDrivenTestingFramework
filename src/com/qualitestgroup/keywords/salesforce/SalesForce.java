package com.qualitestgroup.keywords.salesforce;
...
public class SalesForce extends KeywordGroup {

	private static final String CURR_APP = "salesforce";
	...
	public static class CreateContact extends Keyword {
		...
		public void init() throws KDTKeywordInitException {
			...
			try {
				...
				lastName = args.get("ContactLastName");
	...
	public static class OpportunityStageChange extends Keyword {
		...
		public void exec() throws KDTKeywordExecException {
			...
			try {
				...
				// eo.waitForWebElementVisible(driver, "xpath", "savingVisibility", waiTime,
				// CURR_APP);
				// eo.invisibilityOfElement(driver, "xpath", "savingVisibility", CURR_APP,
				// waiTime);
			...
			try {
				...
				if(accountType.equalsIgnoreCase("Partner/Distributor"))
				{
				    ...
				    // partner lookup
					 ...
					 eo.javaScriptScrollToViewElement(driver, "xpath", "partnerLookupField", CURR_APP);
					 eo.enterText(driver, "xpath", "partnerLookupField",accountname , CURR_APP);
				     driver.findElement(By.xpath(gei.getProperty("partnerLookupField", CURR_APP))).sendKeys(Keys.TAB);
	...
	public static class CreateAndSubmitQuote extends Keyword {
		...
		public void exec() throws KDTKeywordExecException {
			...
			SeleniumTools.waitForWebElementToClickable(driver, By.xpath(gei.getProperty("quote_save_btn", CURR_APP)),
					waiTime);
	...
	public static class VerifyAndSubmitOrder extends Keyword {
			...
			try {
				...
				if (!eo.getText(driver, "xpath", "order_status", CURR_APP).equalsIgnoreCase("Order Accepted")) {
					...
					if (flag == false) {
						...
						this.addComment("The order status is verified" + "order status="
								+ eo.getText(driver, "xpath", "order_status", CURR_APP));
					}
				...
				for (int i = 0; i < dropdownOptionAndValue.length; i++) {
					...
					try {
						if (productTab.equalsIgnoreCase("Support Add-Ons")) {
							eo.waitForWebElementVisibleAfterReplace(driver, "xpath", "filterOptionNameSupport",
									"{label}", label, waiTime, CURR_APP);
							this.addComment("Successfully verified the display of Filter option " + label);
						}

						else {

							eo.waitForWebElementVisibleAfterReplace(driver, "xpath", "filterOptionName", "{label}",
									label, waiTime, CURR_APP);
							this.addComment("Successfully verified the display of Filter option " + label);

						}

						eo.clickElementAfterReplacingKeyValue(driver, "XPATH", "filterOption", "{label}", label,
								CURR_APP);
						...
						this.addComment("Successfully verified the display of drop down value " + value + " for option "
								+ label);
	...
	public static class CompareTwoValuesString extends Keyword {
		...
		public void exec() throws KDTKeywordExecException {
			...
			try {
				...
				throw new KDTKeywordExecException("The expected message is not matching with the actual message", e);
